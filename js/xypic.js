...
//        })
  ...
  AST.Command.Ar.Form.CurveArrow.Augment({
    toShape: function (context) {
      ...
      // the following AST means . too long...
      env.pathActionForBeforeSegment = FP.Option.Some(
        AST.PosDecor(
          AST.Pos.Coord(
            AST.Coord.C(),
